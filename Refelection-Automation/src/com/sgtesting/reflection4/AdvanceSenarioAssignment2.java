...
public class AdvanceSenarioAssignment2{
	...
	public static void loginUser222()
	{
		try
		{
			oPage.getAdminUserName().sendKeys("demouser2");
	...
	public static void logOutUser222()
	{
		try
		{
			oPage.getAdminLogout().click();
	...
	public static void loginUser111()
	{
		try
		{
			oPage.getAdminUserName().sendKeys("demouser1");
	...
	public static void logOutUser111()
	{
		try
		{
			oPage.getAdminLogout().click();
	...
	public static void loginUser2222()
	{
		try
		{
			oPage.getAdminUserName().sendKeys("demouser2");
	...
	public static void logOutUser2222()
	{
		try
		{
			oPage.getAdminLogout().click();
	...
	public static void loginUser1111()
	{
		try
		{
			oPage.getAdminUserName().sendKeys("demouser1");
	...
	public static void logOutUser1111()
	{
		try
		{
			oPage.getAdminLogout().click();
