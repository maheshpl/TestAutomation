...
public static WebDriver oBrowser=null;
	...
	public void minimizeFlyOutWindow()
	{
		try
		{
			...
			Thread.sleep(2000);
			log.info("minimized window succesfully");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	public void modifyUser(String user)
	{
		try
		{
			...
			Thread.sleep(2000);	
			oBrowser.findElement(objectmap.getLocator("usercreationfirstname")).clear();
			Thread.sleep(2000);	
			oBrowser.findElement(objectmap.getLocator("usercreationfirstname")).sendKeys(user);
			Thread.sleep(2000);	
			oBrowser.findElement(objectmap.getLocator("usercreationcreateuserbutton")).click();
			Thread.sleep(2000);
