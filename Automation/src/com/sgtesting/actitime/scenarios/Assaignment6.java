...
public static Logger log=Logger.getLogger("Automation...");
	...
	public  void modifyProject(String modify)
	{
		try
		{
			log.info(path);
			...
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("projectmodifynamefield")).click();
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("projectmodifynamefield1")).clear();
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("projectmodifynamefield1")).sendKeys(modify);
			Thread.sleep(4000);
			oBrowser.findElement(objectmap.getLocator("projectdescriptionclick")).click();
			Thread.sleep(2000);
